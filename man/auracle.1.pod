...
=item B<resolve> I<TERM>

Pass a single dependency string argument to perform a search query for packages
that can satisfy the input dependency. Dependency syntax follows that of pacman
and makepkg, i.e. I<auracle> or I<auracleE<gt>=21>.
