...
B<AUR>        The dependency was found in the AUR and needs to be built and installed. The output will contain an additional column of the pkgbase the package is provided by.
