...
When used with the B<search> command, change the search dimension. I<BY> must
be one of I<name>, I<name-desc>, I<maintainer>, I<depends>, I<makedepends>,
I<optdepends>, or I<checkdepends>.
...
=item B<pkgbuild> I<PACKAGES>...

Pass one to many arguments to print the PKGBUILDs for the given packages.

=item B<rawsearch> I<PACKAGES>...
